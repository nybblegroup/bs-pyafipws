...
# Versión modificada para evitar conflictos con PyPI
# Usamos un prefijo "nybble" para distinguir de la versión original
__version__ = "nybble.1.0.%s" % rev
...
if "sdist" in sys.argv and os.path.exists("README.md") and sys.platform == "linux2":
    try:
        ...
        open("README.rst", "w").write(long_desc)
...
setup(name="PyAfipWs",
      ...
      url="https://github.com/nybblegroup/bs-pyafipws" if not 'py2exe' in sys.argv
